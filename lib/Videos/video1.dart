...
class VideoPage1 extends StatefulWidget {
  const VideoPage1({super.key});

  @override
  State<VideoPage1> createState() => _VideoPage1State();
}

String vTitle = "Steelers @ Ravens 2017 Highlights";
String thumbnail = "Thumbnail1.jpg";
String userpic =
    "https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/giants/hfdfo5i1cqbelcljnask";
String username = "NFL Official";
bool isLike = true;
bool isDislike = true;
