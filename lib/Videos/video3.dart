...
class VideoPage3 extends StatefulWidget {
  const VideoPage3({super.key});

  @override
  State<VideoPage3> createState() => _VideoPage3State();
}

String vTitle = "HersheyPark Skyrush POV";
String thumbnail = "Thumbnail3.jpg";
String userpic ="WoodenCoaster.png";
String username = "CoasterPOVS";
bool isLike = true;
bool isDislike = true;
