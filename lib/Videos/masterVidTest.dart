//This section is in a work in progress to update to masterVid
...
class VideoPageX extends StatefulWidget {
  const VideoPageX({super.key});

  @override
  State<VideoPageX> createState() => _VideoPageXState();
}



class _VideoPageXState extends State<VideoPageX> {
